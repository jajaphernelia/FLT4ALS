...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 14, 2023 at 12:44 PM
...
('ACNT-00000', 'admin', '5f4dcc3b5aa765d61d8327deb882cf99', 'admin', '2023-05-27 16:03:50', 'active', 'online'),
('ACNT-00001', 'teacher', '5f4dcc3b5aa765d61d8327deb882cf99', 'teacher', '2023-05-27 16:03:50', 'active', 'online'),
('ACNT-10001', '136453160522', '5f4dcc3b5aa765d61d8327deb882cf99', 'student', '2023-07-14 12:07:11', 'active', 'offline'),
('ACNT-10002', '517011901717', '5f4dcc3b5aa765d61d8327deb882cf99', 'student', '2023-07-14 12:07:11', 'active', 'offline'),
('ACNT-10003', '136456120450', '5f4dcc3b5aa765d61d8327deb882cf99', 'student', '2023-07-14 12:07:11', 'active', 'offline'),
('ACNT-10004', '136441140382', '5f4dcc3b5aa765d61d8327deb882cf99', 'student', '2023-07-14 12:07:11', 'active', 'offline'),
('ACNT-10005', '136453120376', '5f4dcc3b5aa765d61d8327deb882cf99', 'student', '2023-07-14 12:07:11', 'active', 'offline'),
('ACNT-10006', '136453100031', '5f4dcc3b5aa765d61d8327deb882cf99', 'student', '2023-07-14 12:07:11', 'active', 'offline'),
('ACNT-10007', '136456140697', '5f4dcc3b5aa765d61d8327deb882cf99', 'student', '2023-07-14 12:07:11', 'active', 'offline'),
('ACNT-10008', '136453130519', '5f4dcc3b5aa765d61d8327deb882cf99', 'student', '2023-07-14 12:07:11', 'active', 'offline'),
('ACNT-10009', '136441121334', '5f4dcc3b5aa765d61d8327deb882cf99', 'student', '2023-07-14 12:07:11', 'active', 'offline'),
('ACNT-10010', '136456141479', '5f4dcc3b5aa765d61d8327deb882cf99', 'student', '2023-07-14 12:07:11', 'active', 'offline');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_chat_msg`
--
...
--
-- Dumping data for table `tbl_chat_msg`
--

INSERT INTO `tbl_chat_msg` (`cmsg_id`, `language`, `classification`, `question`, `response`, `status`) VALUES
('CMSG-00000', 'English', 'General', 'Hello!', 'Hi! how can I help you?', 'active'),
('CMSG-00001', 'English', 'General', 'How do I create an account?', 'Your account is provided by the admin or your teacher once you are enrolled.', 'active'),
('CMSG-00002', 'English', 'General', 'What information is required to register for an account?', 'Your enrollment details are needed to register for an account but the admin or teacher will provide your account once you are enrolled.', 'active'),
('CMSG-00003', 'English', 'General', 'Can I use my social media account to register?', 'You cannot use your social media to register, your teacher or the admin is responsible for creating your account.', 'active'),
('CMSG-00004', 'English', 'General', 'Is my personal information secure when creating an account?', 'Your personal information will only be used in this system for your learning progress.', 'active'),
('CMSG-00005', 'English', 'General', 'Can I have multiple accounts with the same email address?', 'You cannot have multiple accounts, your teacher or admin will provide your account once you are enrolled.', 'active'),
('CMSG-00006', 'English', 'General', 'What should I do if I forget my username or password?', 'Ask your teacher regarding about your username and password.', 'active'),
('CMSG-00007', 'English', 'General', 'Can I change my username or email address after registering?', 'You cannot change your username once your account is given, however you can change your password with the help of your teacher or the admin.', 'active'),
('CMSG-00008', 'English', 'General', 'Is it possible to delete my account?', 'It is not possible to delete your account since your account is given by your teacher and it is created carefully together with your details.', 'active'),
('CMSG-00009', 'English', 'General', 'Can I take the Function Literacy Test one more? ', 'Once you took the Function Literacy Test, you cannot retake it, however you can take it once you are instructed by your teacher. ', 'active'),
('CMSG-00010', 'English', 'General', 'Can I review the results of the test I took?', 'After taking the test, you can view the result and let your teacher explain it to you. ', 'active'),
('CMSG-00011', 'Filipino', 'General', 'Paano gumawa ng account?', 'Ang inyong account ay ibinibigay ng admin o ng inyong guro kapag kayo ay nakapag-enroll na.', 'active'),
('CMSG-00012', 'Filipino', 'General', 'Ano ang mga impormasyon na kailangan sa pag gawa ng account?', 'Kailangan ang mga detalye ng inyong pag-eenroll upang makapagrehistro ng account ngunit ang admin o guro ang magbibigay sa inyo ng inyong account kapag kayo ay nakapag-enroll na.', 'active'),
('CMSG-00013', 'Filipino', 'General', 'Maaari ko bang gamitin ang aking social media account sa pag rehistro?', 'Hindi maaaring gamitin ang inyong social media para sa pagpaparehistro, ang inyong guro o admin ang responsable sa paglikha ng inyong account.', 'active'),
('CMSG-00014', 'Filipino', 'General', 'Ligtas ba ang aking personal na impormasyon kapag gumagawa ng account?', 'Ang inyong personal na impormasyon ay gagamitin lamang sa sistemang ito para sa inyong pag-unlad sa pag-aaral.', 'active'),
('CMSG-00015', 'Filipino', 'General', 'Ano ang gagawin ko kapag nakalimutan ko ang aking username at password?', 'Itanong sa inyong guro ang inyong username at password.', 'active'),
('CMSG-00016', 'Filipino', 'General', 'Maaari ko bang palitan ang aking username o email address pagkatapos mag rehistro?', 'Hindi maaaring baguhin ang inyong username kapag ibinigay na ang inyong account, ngunit maaaring baguhin ang inyong password sa tulong ng inyong guro o ng admin.', 'active'),
('CMSG-00017', 'Filipino', 'General', 'Maaari bang burahin ang akin account?', 'Hindi maaaring burahin ang inyong account dahil ang inyong account ay ibinigay ng inyong guro at maingat na nilikha kasama ang inyong mga detalye.', 'active'),
('CMSG-00018', 'Filipino', 'General', 'Maaari ko bang ulitin ang Function Literacy Test?', 'Kapag kayo ay sumagot na ng Function Literacy Test, hindi na kayo maaaring magsagot muli nito, ngunit maaari kayong sumagot nito kapag kayo ay sinabihan ng inyong guro.', 'active'),
('CMSG-00019', 'Filipino', 'General', 'Maaari ko bang rebyuhin ang result ng test na aking kinuha?', 'Matapos gawin ang pagsusulit, maaari niyong tingnan ang resulta at ipapaliwanag ito ng inyong guro.', 'active'),
('CMSG-00020', 'Filipino', 'General', 'Maaari bang burahin ang akin account?', 'Hindi maaaring burahin ang inyong account dahil ang inyong account ay ibinigay ng inyong guro at maingat na nilikha kasama ang inyong mga detalye.', 'active');
...
('EMPL-0000', 'ACNT-00000', 'Juan', '', 'Dela Cruz', '01 Sampl st.', 'Barangay 01', 'Manila', 'Metro Manila', 'Male', '2001-07-12', '111 111 111', 'sample@gmail.com', 'active'),
...
('FLS1E-00001', 'A', 1, 'B', 1, 'D', 1, 'A', 1, 'D', 1, 'Sample Answer for Q6.', 1, 'Sample Answer for Q7.', 1, 'Sample Answer for Q8.', 1, 8, 8, '2023-07-14 12:36:30', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS1E-00002', 'B', 0, 'B', 1, 'D', 1, 'D', 0, 'C', 0, 'Sample Answer for Q6.', 1, 'Sample Answer for Q7.', 1, 'Sample Answer for Q8.', 1, 5, 8, '2023-07-14 13:03:28', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS1E-00003', 'B', 0, 'D', 0, 'B', 0, 'B', 0, 'D', 1, 'Sample Answer for Q6.', 1, 'Sample Answer for Q7.', 1, 'Sample Answer for Q8.', 1, 4, 8, '2023-07-14 13:03:28', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS1E-00004', 'A', 1, 'D', 0, 'D', 1, 'B', 0, 'D', 1, 'Sample Answer for Q6.', 1, 'Sample Answer for Q7.', 1, 'Sample Answer for Q8.', 1, 6, 8, '2023-07-14 13:03:28', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS1E-00005', 'A', 1, 'D', 0, 'D', 1, 'B', 0, 'D', 1, 'Sample Answer for Q6.', 1, 'Sample Answer for Q7.', 1, 'Sample Answer for Q8.', 1, 6, 8, '2023-07-14 13:03:28', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS1E-76492', 'B', 0, 'C', 0, 'C', 0, 'B', 0, 'D', 1, 'Test statement 1. \r\nTest statement 2.\r\nTest statement 3.', 1, 'Testing. Testing.', 1, 'Test statement 1. ', 1, 4, 8, '2023-07-14 17:41:25', NULL, NULL, 'pending');
...
('FLS1F-00001', 'B', 0, 'C', 1, 'D', 0, 'KOMPYUTER', 1, 'Sample Answer for Q8.', 2, 4, 6, '2023-07-14 14:30:59', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS1F-00002', 'C', 1, 'C', 1, 'D', 1, 'KOMPYUTER', 1, 'Sample Answer for Q8.', 2, 6, 6, '2023-07-14 14:30:59', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS1F-00003', 'B', 0, 'C', 1, 'A', 1, 'KOMPYUTER', 1, 'Sample Answer for Q8.', 2, 5, 6, '2023-07-14 14:30:59', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS1F-00004', 'B', 0, 'D', 0, 'A', 1, 'KOMPYUTER', 1, 'Sample Answer for Q8.', 2, 4, 6, '2023-07-14 14:30:59', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS1F-00005', 'B', 0, 'C', 1, 'D', 0, 'KOMPYUTER', 1, 'Sample Answer for Q8.', 2, 4, 6, '2023-07-14 14:30:59', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS1F-34670', 'D', 0, 'B', 0, 'C', 0, 'Test statement 1. \r\nTest statement 2.\r\nTest statement 3.', 0, 'testing', 0, 0, 6, '2023-07-14 17:43:06', NULL, NULL, 'pending');
...
('FLS2-00001', 'D', 1, 'C', 1, 'C', 1, 'B', 1, 'D', 1, 5, 5, '2023-07-14 12:40:54', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS2-00002', 'D', 1, 'D', 0, 'A', 0, 'C', 0, 'D', 1, 2, 5, '2023-07-14 13:01:01', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS2-00003', 'C', 0, 'C', 1, 'C', 1, 'D', 0, 'D', 1, 3, 5, '2023-07-14 13:01:01', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS2-00004', 'C', 0, 'C', 1, 'C', 1, 'D', 0, 'D', 1, 3, 5, '2023-07-14 13:01:01', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS2-00005', 'C', 0, 'C', 1, 'D', 0, 'D', 0, 'D', 1, 2, 5, '2023-07-14 13:01:01', '2023-07-14', 'EMPL-0001', 'checked');
...
('FLS3-00001', 'D', 1, 'D', 0, 'C', 0, 'D', 0, 'D', 0, 'A', 1, 'D', 1, 'C', 1, 4, 8, '2023-07-14 13:36:52', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS3-00002', 'D', 1, 'D', 0, 'C', 0, 'D', 0, 'D', 0, 'A', 1, 'D', 1, 'C', 1, 4, 8, '2023-07-14 13:36:52', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS3-00003', 'D', 1, 'D', 0, 'C', 0, 'D', 0, 'D', 0, 'A', 1, 'D', 0, 'C', 1, 3, 8, '2023-07-14 13:36:52', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS3-00004', 'D', 1, 'D', 0, 'C', 0, 'D', 0, 'D', 0, 'A', 1, 'D', 1, 'C', 1, 4, 8, '2023-07-14 13:36:52', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS3-00005', 'D', 1, 'D', 0, 'C', 0, 'D', 0, 'D', 0, 'A', 1, 'D', 1, 'C', 1, 4, 8, '2023-07-14 13:36:52', '2023-07-14', 'EMPL-0001', 'checked');
...
('FLS4-00001', 'D', 0, 'A', 1, 'B', 1, 'C', 0, 'C', 1, 'A', 1, 4, 6, '2023-07-14 13:46:23', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS4-00002', 'C', 1, 'A', 1, 'B', 1, 'D', 1, 'C', 1, 'A', 1, 6, 6, '2023-07-14 13:46:23', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS4-00003', 'D', 0, 'A', 1, 'B', 1, 'C', 0, 'C', 1, 'A', 1, 4, 6, '2023-07-14 13:46:23', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS4-00004', 'D', 0, 'A', 1, 'B', 1, 'C', 0, 'C', 1, 'A', 1, 4, 6, '2023-07-14 13:46:23', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS4-00005', 'D', 0, 'A', 1, 'B', 1, 'C', 0, 'C', 1, 'A', 1, 4, 6, '2023-07-14 13:46:23', '2023-07-14', 'EMPL-0001', 'checked');
...
('FLS5-00001', 'D', 1, 'A', 1, 'A', 1, 'C', 1, 'B', 1, 5, 5, '2023-07-14 14:24:54', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS5-00002', 'D', 1, 'A', 1, 'A', 1, 'C', 1, 'B', 1, 5, 5, '2023-07-14 14:24:54', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS5-00003', 'B', 0, 'B', 0, 'A', 1, 'C', 1, 'B', 1, 3, 5, '2023-07-14 14:24:54', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS5-00004', 'B', 0, 'B', 0, 'C', 0, 'C', 1, 'B', 1, 2, 5, '2023-07-14 14:24:54', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS5-00005', 'B', 0, 'B', 0, 'C', 0, 'D', 0, 'B', 1, 2, 5, '2023-07-14 14:24:54', '2023-07-14', 'EMPL-0001', 'checked');
...
('FLS6-00001', 'D', 1, 'C', 1, 'D', 1, 'C', 1, 'A', 1, 'D', 1, 6, 6, '2023-07-14 14:24:46', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS6-00002', 'D', 1, 'C', 1, 'D', 1, 'C', 1, 'A', 1, 'D', 1, 6, 6, '2023-07-14 14:24:46', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS6-00003', 'D', 1, 'C', 1, 'C', 0, 'C', 1, 'A', 1, 'D', 1, 5, 6, '2023-07-14 14:24:46', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS6-00004', 'D', 1, 'C', 1, 'C', 0, 'D', 0, 'A', 1, 'D', 1, 4, 6, '2023-07-14 14:24:46', '2023-07-14', 'EMPL-0001', 'checked'),
('FLS6-00005', 'D', 1, 'C', 1, 'C', 0, 'D', 0, 'D', 0, 'D', 1, 3, 6, '2023-07-14 14:24:46', '2023-07-14', 'EMPL-0001', 'checked');
...
('FPIS-12694', '517011901717', 'Alex Christian', '', 'Avelino', 1, 'Male', 1, '1998-02-09', 1, '02 Sample St.', '212', 'Manila', 'Metro Manila', 1, 'Roman Catholic', 1, 'Biyudo/Biyuda', 1, 'N/A', 1, 'Grade 4', 1, 'Test statement 1. \r\nTest statement 2.\r\nTest statement 3.', 1, 9, 10, '2023-07-14 12:52:11', NULL, NULL, 'checked'),
('FPIS-19320', '136453160522', 'Mark Theodore', 'Anadon', 'Mesiona', 1, 'Male', 1, '1994-01-05', 1, '01 Sample St.', '21', 'Manila', 'Metro Manila', 1, 'Roman Catholic', 1, 'Walang asawa', 1, 'N/A', 1, 'Elementary Grade 3', 1, 'Test statement 1. \r\nTest statement 2.\r\nTest statement 3.', 1, 9, 10, '2023-07-14 12:27:19', '2023-07-14', 'EMPL-0001', 'checked'),
('FPIS-34679', '136453100031', 'Ashley', 'Diaz', 'Ashley', 1, 'Female', 1, '1991-01-17', 1, '01 Sampl st.', '21', 'Manila', 'Metro Manila', 1, 'Roman Catholic', 1, 'Walang asawa', 1, 'N/A', 1, 'Grade 4', 1, 'Test statement 1. \r\nTest statement 2.\r\nTest statement 3.', 2, 10, 10, '2023-07-14 13:15:07', '2023-07-14', 'EMPL-0001', 'checked'),
('FPIS-46238', '136456120450', 'John Kenny', 'Ticala', 'Denosta', 1, 'Male', 1, '1989-05-07', 1, '01 Sample St.', '212', 'Manila', 'Metro Manila', 1, 'Roman Catholic', 1, 'Walang asawa', 1, 'N/A', 1, 'Grade 2', 1, 'Test statement 1. \r\nTest statement 2.\r\nTest statement 3.', 1, 9, 10, '2023-07-14 13:20:24', '2023-07-14', 'EMPL-0001', 'checked'),
('FPIS-74935', '136456140697', ' Aira Mae', 'Gepulle', 'Castillo', 1, 'Female', 1, '1986-02-14', 1, '02 Sample St.', '22', 'Manila', 'Metro Manila', 1, 'Roman Catholic', 1, 'Walang asawa', 1, 'N/A', 1, 'Grade 4', 1, 'Test statement 1. \r\nTest statement 2.\r\nTest statement 3.', 1, 9, 10, '2023-07-14 13:17:40', '2023-07-14', 'EMPL-0001', 'checked'),
('FPIS-95371', '136453130519', ' Kimberly', 'Kadil', 'Labadia', 1, 'Female', 1, '1996-03-03', 1, '01 Sample St.', '21', 'Manila', 'Metro Manila', 1, 'Roman Catholic', 1, 'Walang asawa', 1, 'N/A', 1, 'Grade 4', 1, 'Test statement 1. \r\nTest statement 2.\r\nTest statement 3.', 1, 9, 10, '2023-07-14 17:40:27', NULL, NULL, 'pending');
...
('MODL-10106', 'SUBJ-00101', 6, 'Aralin 6', '', 'All Modules', 'Aralin-6.pdf', '2023-06-17 16:55:52', 'active'),
('MODL-10107', 'SUBJ-00101', 7, 'Aralin 7', '', 'All Modules', 'Aralin-7.pdf', '2023-06-17 16:55:52', 'active'),
('MODL-10108', 'SUBJ-00101', 8, 'Aralin 8', '', 'All Modules', 'Aralin-8.pdf', '2023-06-17 16:55:52', 'active'),
...
('136441121334', 'ACNT-10009', 'Rosedy Marie', 'Trono', 'Lavapie', 'new', 'new'),
('136441140382', 'ACNT-10004', 'Edilberto JR', 'Fuentes', 'Igloso', 'new', 'new'),
('136453100031', 'ACNT-10006', 'Ashley', 'Diaz', 'Ashley', 'Female', 'active'),
('136453120376', 'ACNT-10005', 'Kian', 'Magno', 'Maang', 'new', 'new'),
('136453130519', 'ACNT-10008', 'Kimberly', 'Kadil', 'Labadia', 'Female', 'active'),
('136453160522', 'ACNT-10001', 'Mark Theodore', 'Anadon', 'Mesiona', 'Male', 'active'),
('136456120450', 'ACNT-10003', 'John Kenny', 'Ticala', 'Denosta', 'Male', 'active'),
('136456140697', 'ACNT-10007', ' Aira Mae', 'Gepulle', 'Castillo', 'Female', 'active'),
('136456141479', 'ACNT-10010', 'Enma Ruth', 'Mata', 'Linde', 'new', 'new'),
('517011901717', 'ACNT-10002', 'Alex Christian', '', 'Avelino', 'Male', 'active');
...
('SFLT-00001', 'SHYR-00001', 'TPRD-00001', '517011901717', 'FPIS-12694', 'FLS1E-00001', 'FLS1F-00001', 'FLS2-00001', 'FLS3-00001', 'FLS4-00001', 'FLS5-00001', 'FLS6-00001', 'completed'),
('SFLT-00002', 'SHYR-00001', 'TPRD-00001', '136453160522', 'FPIS-19320', 'FLS1E-00002', 'FLS1F-00002', 'FLS2-00002', 'FLS3-00002', 'FLS4-00002', 'FLS5-00002', 'FLS6-00002', 'completed'),
('SFLT-00003', 'SHYR-00001', 'TPRD-00001', '136453100031', 'FPIS-34679', 'FLS1E-00003', 'FLS1F-00003', 'FLS2-00003', 'FLS3-00003', 'FLS4-00003', 'FLS5-00003', 'FLS6-00003', 'completed'),
('SFLT-00004', 'SHYR-00001', 'TPRD-00001', '136456120450', 'FPIS-46238', 'FLS1E-00004', 'FLS1F-00004', 'FLS2-00004', 'FLS3-00004', 'FLS4-00004', 'FLS5-00004', 'FLS6-00004', 'completed'),
('SFLT-00005', 'SHYR-00001', 'TPRD-00001', '136456140697', 'FPIS-74935', 'FLS1E-00005', 'FLS1F-00005', 'FLS2-00005', 'FLS3-00005', 'FLS4-00005', 'FLS5-00005', 'FLS6-00005', 'completed'),
('SFLT-95371', 'SHYR-00001', 'TPRD-00001', '136453130519', 'FPIS-95371', 'FLS1E-76492', 'FLS1F-34670', NULL, NULL, NULL, NULL, NULL, 'pending');
...
('TPRD-00001', 'Pre-test', 'active'),
('TPRD-00002', 'Post-test', 'close'),
('TPRD-00003', 'Closed', 'active');
...
--
-- Indexes for table `tbl_chat_msg`
--
ALTER TABLE `tbl_chat_msg`
  ADD PRIMARY KEY (`cmsg_id`);
