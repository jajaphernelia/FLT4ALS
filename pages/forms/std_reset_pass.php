...
<?php 
  ...
  $studentData = GetStudentAccount($conn, $selectedStudent);
?>
<html lang="en">
            ...
            <div class="card my-2">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-4">
                <div class="bg-gradient-info shadow-none border-radius-lg pt-3 pb-1">
                  <h6 class="text-white text-lg text-center text-uppercase">STUDENT ACCOUNT</h6>
                </div>
              </div>
              ...
              <div class="card-body px-4 py-2">
                <form role="form" class="text-start" action="" method="POST">
                    ...
                    <div class="col-md-12 col-sm-12 text-end">
                        <button class="btn bg-gradient-success my-2" type="submit" value="<?=$selectedStudent?>" name="update_student_account">
