...
<?php 
  ...
  $stdFLTSubjectID = GetFLTSubjectID($conn, $selectedStudent, $ActiveSchoolYearID, $ActiveTestPeriodID, 'LS4 ID');
...
<head>
  ...
  <title>
    FLT4ALS | Student LS4 Learning and Career Skills
  </title>
  <!-- plugins -->
  <?=$PagesPlugins?>
...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
        <a class="nav-link active bg-secondary text-white" href="<?=$Teacher_FLT_LS4?>">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="material-icons opacity-10">book</i>
            </div>
      ...
      <div class="container-fluid py-1 px-0">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Student LS4 Learning and Career Skills</li>
          </ol>
              ...
              <div class="card">
                <div class="card-header p-3 pt-2">
                  ...
                  <div class="text-end pt-1">
                    ...
                    <h5 class="mb-0 ps-5">LS4 Learning and Career Skills</h5>
                  </div>
                </div>
                <hr class="dark horizontal my-0">
                <div class="card-footer py-2 tx-3">
                ...
                <div class="card-header pb-0 p-3">
                  <div class="row">
                    <div class="col-12 text-center">
                      <h6 class="mb-0 text-secondary text-uppercase">LS4 Learning and Career Skills</h6>
                  ...
                  <form role="form" class="text-start" action="../../assets/php/config.php" method="POST">
                    ...
                    <div class="row mt-1">
                      <label class="input-label text-md">
                        ...
                        <?=CorrectAnswerIndicator($row_data['q4_answer'],'D')?>
                      </label>
                      <div class="col-md-6 col-sm-6">
                          <div class="form-check">
                    ...
                    <div class="row mt-1">
                      <label class="input-label text-md">
                        ...
                        <?=CorrectAnswerIndicator($row_data['q5_answer'],'C')?>
                      </label>
                      <div class="col-md-6 col-sm-6">
                          <div class="form-check">
            ...
            <div style="max-height: 1000px; overflow: auto;" class="card-body px-2 py-2" id="activeStudentTable">
              <ul class="list-group">
                ...
                while ($row_data=$List_Student-> fetch_assoc()){
                    if ($row_data['LS4 Status'] == "checked"){
                    $status_badge = "success";
                    $student_flt_status = $row_data['LS4 Total Score'].'/'.$row_data['LS4 Max Score'];
                    } else if ($row_data['LS4 Status'] == "pending"){
                    $status_badge = "warning";
                    $student_flt_status = $row_data['LS4 Total Score'].'/'.$row_data['LS4 Max Score'];
                    } else if ( $row_data['LS4 Status'] == NULL){
                      $status_badge = "info";
                ...
                <a href="<?=$Teacher_FLT_LS4?>?lrn=<?=$row_data['LRN']?>" class="border-secondary border-radius-lg">
