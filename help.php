...
function userMsgContainer(msg){
  return '<div class="d-flex justify-content-end align-items-start mb-2 ps-8"><span class="bg-success text-md text-white border border-radius-lg py-1 px-2">' + msg + '</span><img src="<?=$UserIcon?>" height="25px" class="border border-radius-xl ms-2 mt-1"></div>';
}

faqs = {
  "Hello" : "Hi there!"
  <?php $List_Faqs = mysqli_query($conn,"SELECT * FROM `tbl_chat_msg`");
    if ($List_Faqs->num_rows>0){ 
...
<body class="bg-gray-200">
  ...
  <main id="mainContainer" class="main-content mt-6 pt-4">
    <div class="container-fluid mb-0 p-0">
      <div class="row d-flex justify-content-center px-4 m-0">
          ...
          <div class="card p-0 bg-transparent shadow-none">
            ...
            <div class="card-body p-0 pe-2 overflow-auto" style="max-height: 750px;" >
              <div class="overflow-auto m-2">
                <?php $List_Quest = mysqli_query($conn,"SELECT * FROM `tbl_chat_msg`");
